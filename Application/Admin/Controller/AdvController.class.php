...
class AdvController extends AdminController
{
    ...
    public function editPos()
    {
        ...
        if (IS_POST) {
            ...
            if ($pos['type'] == 2) {
                ...
                $builder->keyRadio('style', '轮播_风格', '', array(1 => 'simpleslider 风格', 2 => 'KinmaxShow 风格', 3 =>'Flickity 风格'))->keyDefault('style', 1);
    ...
    public function editAdv()
    {
        ...
        if (IS_POST) {
            ...
            $adv['description'] = I('description', '', 'text');
            $adv['pos_id'] = $aPosId;
            $adv['url'] = I('url', '', 'text');
            ...
            if ($pos['type'] == 2) {
                ...
                $aDescription = I('description', '', 'text');
                $aUrl = I('url', '', 'text');
                $aSort = I('sort', '', 'intval');
