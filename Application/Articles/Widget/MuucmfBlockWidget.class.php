...
class MuucmfBlockWidget extends Controller{
    public function render()
    {
        $this->assignArticles();
        $this->display(T('Application://Articles@Widget/muucmfblock'));
    }

    private function assignArticles()
    {
        ...
        if (!$list) {
            ...
            S('articles_muucmf_data', $list, $cache);
        }
        unset($v);
        if($list==1){
            $list=null;
