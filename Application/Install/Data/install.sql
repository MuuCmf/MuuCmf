...
(135, 'DEFUALT_HOME_URL', 1, '登录前首页Url', 1, '', '支持形如articles/index/index的ThinkPhp路由写法，支持普通的url写法，不填则显示默认首页', 1417509438, 1427340006, 1, '', 1),
...
(235, '公告送达情况', 234, 0, 'Announce/arrive', 0, '', '公告管理', 0, '', ''),
(236, '设置公告状态', 234, 0, 'Announce/setStatus', 0, '', '公告管理', 0, '', ''),
(237, '发布公告', 197, 0, 'announce/add', 0, '', '公告管理', 0, '', ''),
(238, '公告编辑', 234, 0, 'announce/edit', 0, '', '公告管理', 0, '', ''),
(240, '消息设置', 197, 0, 'message/config', 0, '', '消息设置', 0, '', ''),
(241, '系统升级流程', 237, 0, 'Update/startupdate', 0, '', '', 0, '', ''),
