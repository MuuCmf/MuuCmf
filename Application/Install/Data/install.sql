...
(1005, '_CONFIG_ABOUT_US', 0, '', 0, '', '', 1427339647, 1427339647, 1, '<style>.common-aboutus .aboutus{margin:10px auto;width:100px}.common-aboutus .aboutus ul{list-style:none}.common-aboutus .aboutus ul li{padding:10px;list-style:none}</style><div class="row"><div class="col-xs-6"><img src=""> <img src="/Public/images/logo.png" class="logo" alt="MuuCmf开源PHP后端开发框架"><p>MuuCmf是一个将CMS和Framework两个概念完美结合的内容管理系统，提供了丰富的系统功能。开发人员只需要专注于业务系统的开发，或通过MuuCmf应用商店下载你需要的模块实现更快部署...。</p><p>软件和方案集成咨询</p><h3>18618380435</h3><p>技术支持邮箱</p><h3>support@hoomuu.cn</h3></div><div class="col-xs-6"><div class="aboutus text-center"><h2>关于我们</h2><ul class="list-padding"><li><a>MuuCmf简介</a></li><li><a>招兵买马</a></li><li><a>BLOG</a></li><li><a>媒体报道</a></li><li><a>服务条款</a></li></ul></div></div></div>', 0),
(1006, '_CONFIG_SUBSCRIB_US', 0, '', 0, '', '', 1427339647, 1427339647, 1, '<div class="text-center"><p>移动端访问</p><div style="width:150px;margin:10px auto;"><img src="#" class="img-responsive" /></div></div>', 0),
